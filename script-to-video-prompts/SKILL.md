...
description: AI视频提示词全能生成器。支持三种模式：A）剧本→分镜→提示词；B）一句话创意→Seedance/即梦平台级提示词；C）对标视频拆解与爆款重构。当用户提到以下任意关键词时触发——口语类："做视频"、"拍视频"、"搞个视频"、"视频文案"、"写提示词"、"写分镜"、"分镜"、"视频脚本"、"镜头"；意图类："帮我做视频"、"我有个剧本"、"剧本转视频"、"拆解视频"、"分析视频"、"分析这个视频"、"学爆款"、"模仿视频"、"拆片"；技术类："AI视频"、"AI做视频"、"AI生成视频"、"文生视频"、"图生视频"、"视频提示词"、"视频生成"、"prompt"；平台类："Seedance"、"seedance"、"即梦"、"即梦平台"；场景类："短剧"、"广告视频"、"视频延长"、"对标拆解"、"爆款分析"、"短视频"。
---
